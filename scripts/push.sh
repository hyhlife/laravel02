...
docker tag app-backend2:latest registry.cn-hangzhou.aliyuncs.com/hyhlife/app-backend2:latest
docker push registry.cn-hangzhou.aliyuncs.com/hyhlife/app-backend2:latest

if [ $# -gt 0 ] ; then
  tag=$1
  docker tag app-backend2:latest registry.cn-hangzhou.aliyuncs.com/hyhlife/app-backend2:${tag}
